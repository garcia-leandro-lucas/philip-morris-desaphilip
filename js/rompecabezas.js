        ...
        var rompecabezas = {
            ...
            _mostrar: function() {
                ...
                if (!rompecabezas._get("div_content")) {
                    ...
                    rompecabezas._get("rompecabezasImagen").removeClass('posic');
                    rompecabezas._get("rompecabezasImagen").innerHTML = '';
                    rompecabezas._get("rompecabezasImagen").className = 'posic';
                }
            },
            ...
            _compruebaFin: function() {
                ...
                setTimeout(function() {
                    if (fin) {
                        alert("Felicitaciones, tu código es: xxx")
                    }
                }, 600);
            },
